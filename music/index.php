...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        ...
        <meta name="keywords" content="music, playlist, upload"/>
        ...
        <?php if ($PAGE == "MUSIC") { ?>
            ...
            <meta name="twitter:title" content="<?php echo $_MUSIC_TITLE; ?>" />
            <meta name="twitter:description" content="Music" />
            <meta name="twitter:image" content="<?php echo $_MUSIC_IMG; ?>" />
            <meta property="og:type" content="article"/>
            <meta property="og:title" content="<?php echo $_MUSIC_TITLE; ?>"/>
            <meta property="og:url" content="<?php echo $_MUSIC_MUSIC; ?>"/>
            <meta property="og:image" content="<?php echo $_MUSIC_IMG; ?>"/>
            <meta property="og:site_name" content="Initedit Music"/>
            <meta property="music:musician" content="<?php echo $_MUSIC_USERNAME; ?>"/>
            <meta itemscope itemtype="http://schema.org/Article" />
            <meta itemprop="headline" content="<?php echo $_MUSIC_TITLE; ?>" />
            <meta itemprop="description" content="Music" />
            <meta itemprop="image" content="<?php echo $_MUSIC_IMG; ?>" />
        <?php } ?>
        <title> Music - Listen To Awesome Music</title>
        <link rel="icon" href="/favicon.ico"/>
        <style>
           <?php $COLOR = "18F3AD"; include "css/index.php";?>
        </style>
        <style>
            .sprite {
                background-image: url(/image/spritesheet3.png?6);
    ...
    <body>
        ...
        <div class="mediaPlayerContainer" id="mediaPlayerContainer">
            <ul class="hl bottomPlayer" style="margin:0 auto;width: 70%;min-width: 950px;">
                ...
                <li style="height: 100%;line-height: 55px;" id="audioCurrentTime">00:00</li>
                ...
                <li style="height: 100%;line-height: 55px;" id="audioEndTime">00:00</li>
                ...
                <li style="background-color: #EEE;min-width: 100px;padding-left: 10px;padding-right: 10px;min-width: 200px;float:right;margin-right: 0px;">
                    <div>
                        <ul class="hl">
                            ...
                            <li>
                                <ul class="vl">
                                    <li id="currentPlayingMusicTitle" style="width:150px;"></li>
                                    <li id="currentPlayingMusicUploader"></li>
                                </ul>
                            </li>
                        </ul>
        ...
        <div class="header">
            <ul class="hl">
                <li class="homeButton"><a href="/"> <span style="color:#555;padding-right:3px; " href="/">Initedit</span><span class="homeMusicTitle" style="" href="/">Music</span></a></li>
            ...
            <ul class="hl">
                ...
                <li style="float:right">
                    <ul class="hl" style="overflow: hidden;line-height: normal;padding-top: 10px;">
                        <li><a href="" class="ancharNewPage" target="_blank"  style=" padding:0px;padding-top:10px;"><i class="sprite sprite-google" style="margin-right: 10px;"></i></a></li>
                        <li><a href="" target="_blank" class="ancharNewPage" style=" padding:0px;padding-top:10px;"><i class="sprite sprite-facebook" style="margin-right: 10px;"></i></a></li>
                        <li><a href="" class="ancharNewPage" target="_blank" style=" padding:0px;padding-top:10px;"><i class="sprite sprite-twitter" style="margin-right: 10px;"></i></a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <div class="clearFix"></div>
        <!--<script type="text/javascript"  src="/js/mini_all.js?10"></script>-->
