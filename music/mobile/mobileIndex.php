    ...
    <body>
        ...
        <ul class="vl">
            ...
            <li class="footer">
                <ul class="hl">
                    <li >Follow Us : </li>
                    <li><a href=""  style=" padding:0px;padding-top:10px;"><i class="sprite sprite-google" style="margin-right: 10px;"></i></a></li>
                    <li><a href=""  style=" padding:0px;padding-top:10px;"><i class="sprite sprite-facebook" style="margin-right: 10px;"></i></a></li>
                    <li><a href=""  style=" padding:0px;padding-top:10px;"><i class="sprite sprite-twitter" style="margin-right: 10px;"></i></a></li>
