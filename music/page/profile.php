...
<div id="userProfileCoverPic" style="position: relative;background: url(/upload/profile/cover/<?php echo $PROFILE_COVER; ?>);background-size: cover;background-repeat: no-repeat;/*background:linear-gradient(#AAA,#EEE);background:-webkit-linear-gradient(#AAA,#EEE)*/;overflow:hidden;min-height: 300px; ">
    <?php
    if ($PROFILE_USERNAME === $LOGGED_USER_NAME) {
        ?>
        <div style="position: absolute;top: 50px;right: 50px;">
            <input type="button" value="Upload Cover Image" style="padding: 5px 10px;"/>
            <input type="file" accept="image/gif, image/jpeg, image/png" onchange="previewAndUploadProfileCover()" id="uploadProfileCoverInput"  style="padding: 5px 10px;opacity: 0;position: absolute;top:0px;left:0px;width: 100%;height: 100%;"/>
        </div>
    <?php } ?>
...
<div style="position: relative;padding-left: 15%;background:#FFF;overflow: hidden;">
    <ul class="hl profileList">
        ...
        <li <?php echo ($PROFILE_SUB_MENU == "liked") ? "class='profileMenuBorder' style=''" : "" ?>><a href="/user/<?php echo $PROFILE_USERNAME; ?>/liked">Liked</a></li>
        ...
        if ($PROFILE_USERNAME === $LOGGED_USER_NAME) {
            ...
            <li <?php echo ($PROFILE_SUB_MENU == "setting") ? "class='profileMenuBorder' style=''" : "" ?>><a href="/user/<?php echo $PROFILE_USERNAME; ?>/setting">Setting</a></li>
        <?php } ?>
    </ul>
</div>
