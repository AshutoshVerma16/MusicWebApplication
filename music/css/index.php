...
.footer{
height: 50px;
border-top: 1px solid #<?php echo $_COLOR;?>;
background:#FFF;
color:#000;
line-height: 50px;
}
...
z-index: 11;display: none;position:fixed;bottom: 0px;height:55px;background:rgba(255,255,255,0.95);width: 100%;border-top:1px solid #<?php echo $_COLOR;?>;padding-top: 2.5px;
}
...
.messageBox{
                box-shadow: 5px 5px 3px #888888;padding: 10px;margin-bottom: 10px;overflow: hidden;width: 200px;border-radius: 2px;
                opacity: 0;
                transition: opacity 0.5s;
                -webkit-transition: opacity 0.5s;
                -o-transition: opacity 0.5s;
            ...
            .homeMusicTitle{
                color:#<?php echo $_COLOR;?>;font-weight: 100;
            }