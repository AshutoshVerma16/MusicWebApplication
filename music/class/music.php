...
class MusicView {
    ...
    <ul class="vl musicSortCard" style="overflow: visible;" id="musicSortCard_<?php echo $model->filename; ?>">
            <li class="eh"  data-musicid="<?php echo $model->filename; ?>" style="position: relative;cursor: pointer;">
                ...
                <div style="position: absolute;left: 50px;top: 50px;display: none;width:100%;" id="hoverCardMusic_<?php echo $model->filename; ?>" class="hoverPlayButton">
                    <div id="hoverCardMusic_sprite_<?php echo $model->filename; ?>" class="sprite sprite-hoverPlayIcon" style="height:50px;width:50px;"></div>
            ...
            <li>
                <ul class="hl">
                    <li>
                        <ul class="vl">
                            <li style="font-size: 0.9em;width: 150px;overflow: hidden;height: 20px"><a href="/music/<?php echo $model->url; ?>" style="word-break: break-all;"><?php echo $model->title; ?></a></li>
                            <li style="font-size: 0.8em;">by <a href="/user/<?php echo $model->userName; ?>/overview"><?php echo $model->userName; ?></a></li>
                        </ul>
                    </li>
